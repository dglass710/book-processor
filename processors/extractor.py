...
def _extract_page_worker(args) -> Tuple[int, Optional[str], bool, str]:
    ...
    try:
        ...
        output_file = os.path.join(output_dir, f"{prefix}-{page_num + 1:03d}.{fmt}")
...
class PDFExtractor:
    ...
    def get_pdf_info(self, pdf_path):
        ...
        try:
            with open(pdf_path, "rb") as f:
                ...
                return {"page_count": num_pages, "title": title, "author": author}
        except Exception as e:
    ...
    def extract_images_with_pymupdf(
        ...
        try:
            ...
            return (
                True,
                f"Successfully extracted {len(extracted_files)} images",
                extracted_files,
            )
    ...
    def extract_text_per_page(self, pdf_path, output_dir, prefix="page"):
        ...
        return (
            True,
            f"Successfully extracted text from {len(output_files)} pages",
            output_files,
        )
